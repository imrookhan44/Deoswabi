...
function NonTeaching() {
    ...
    return (
        ...
        <>
            ...
            <>
                <Table  size="lg" className="table mt-4" id='nonTeaching'>
                    <tr>
                    ...
                    {data2?.map(({ id, data , index}) => (
                        <tr key={id}>
                            ...
                            <td>
                                <button className='btn-info' onClick={() => db.collection("nonTeaching").doc(id).update({
                                    total: total,
                                    present: present,
                                    absent: absent,
                                    leave: leave,
                            ...
                            <td>
                                <button className='btn btn-danger' onClick={() => db.collection("nonTeaching").doc(id).delete()} style={{ color: "black" }}>Delete</button>
