                ...
                <Table  size="lg">
                    ...
                    {data1?.map(({ id, index,data }) => (
                        <tr key={id}>
                            ...
                            <td>
                                <button className='btn btn-info' onClick={() => db.collection("Teaching").doc(id).update({
                                    total: total,
                                    present: present,
                                    absent: absent,
                                    leave: leave,
                            ...
                            <td>
                                <button className='btn btn-danger' onClick={() => db.collection("Teaching").doc(id).delete()} style={{color: "black"}}>Delete</button>

                            </td>

                        </tr>
                        ///button onClick update data in firebase firestore
